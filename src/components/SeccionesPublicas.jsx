...
export function TiendaSupabase() {
  ...
  const ProductCard = ({ item }) => (
    <article data-card className="shrink-0 w-[65vw] md:w-[280px] snap-start bg-white rounded-2xl shadow hover:shadow-lg transition-shadow overflow-hidden flex flex-col">
