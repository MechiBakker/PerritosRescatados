    ...
    <>
      <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center px-4" onClick={onClose}>
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-xl max-h-[90vh] overflow-y-auto"
          ...
          {/* Foto principal */}
          {fotos[0] && (
            <div className="relative cursor-zoom-in" onClick={() => setLightbox(0)}>
              <img src={fotos[0]} alt={noticia.titulo} className="w-full h-56 object-cover rounded-t-2xl" />
            </div>
          )}
            ...
            {noticias.map((n) => {
              ...
              return (
                <article
                  ...
                  className="bg-white border border-slate-100 rounded-2xl shadow hover:shadow-md transition cursor-pointer overflow-hidden flex flex-col"
                >
                  {fotos[0] ? (
